...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsCompletion_rendersSuccessfullyLoadedComments() {
        ...
        let comment1 = makeComment(message: "another message", username: "another location")
    ...
    func test_loadCommenstCompletion_rendersSuccessfullyLoadedEmptyCommentsAfterNonEmptyComments() {
    ...
    func test_loadCommenstCompletion_rendersErrorMessageOnErrorUntilNextReload() {
        let (sut, loader) = makeSUT()
