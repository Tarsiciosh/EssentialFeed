...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_delete_emptiesPreviouslyInsertedCache() {
        ...
        XCTAssertNil(deletionError, "Expected no-empty cache deletion to succeed")
        expect(sut, toRetrieve: .empty)
    }
    ...
    private func expect(_ sut: CodableFeedStore, toRetrieveTwice expectedResult: RetrieveCahedFeedResult, file: StaticString = #filePath, line: UInt = #line){
        expect(sut, toRetrieve: expectedResult, file: file, line: line)
        expect(sut, toRetrieve: expectedResult, file: file, line: line)
    }
    
    private func expect(_ sut: CodableFeedStore, toRetrieve expectedResult: RetrieveCahedFeedResult, file: StaticString = #filePath, line: UInt = #line){
        ...
        sut.retrieve { retrieveResult in
            ...
            case let (.found(retrievedFeed, retrievedTimestamp), .found(feed: expectedFeed, timestamp: expectedTimestamp)):
