...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    override func setUp() async throws { //call before each test mehtod
        try await super.setUp()
        URLProtocolStub.startInterceptingRequests()
    }
    
    override func tearDown() { //call after each test method
        super.tearDown()
    ...
    func test_getFromURL_failsOnRequestError() {
        let requesError = NSError(domain: "any error", code: 1)
